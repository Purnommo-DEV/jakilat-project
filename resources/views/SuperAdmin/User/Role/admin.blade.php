			...
			<tr>
				@if ($item->user->role == 'Admin')
					...
					<td>
						...
						data-target="#detailModalAdmin-{{ $item->id }}">Detail</button>
					</td>
				@else
				<label for="">Tidak di Temukan</label>
				@endif
			</tr>
			<div class="modal fade" id="detailModalAdmin-{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
				aria-hidden="true">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						...
						<div class="modal-body">
							<img src="../admin/foto_diri/{{ $item->foto_diri }}" class="img-thumbnail" alt="">
							<div class="row">
