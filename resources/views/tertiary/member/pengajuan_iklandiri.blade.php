<div id="iklankan" uk-modal>
    <div class="uk-modal-dialog uk-modal-body roundey">
        <h2 class="uk-modal-title">Iklankan Diri Anda</h2>
        ...
        <form class="row g-3" action="{{route('IklankanMember')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-12" uk-tooltip="Pastikan Gambar Terlihat Jelas">
                <div class="uk-upload-box">
                    ...
                    <div class="drop__zone uk-placeholder uk-text-center">
                      ...
                      <div uk-form-custom>
                        <input name="bukti_bayar" type="file" class="form-control" id="inputFoto"
            ...
            <div class="col-12">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="invalidCheck3">
                        Dengan sumbit anda telah menyetujui 
                        <a href="ketentuan">syarat dan ketentuan </a> yang tersedia.
                    </label>
            ...
            <p>Setelah mengisi data, nama anda akan berada di antrian untuk iklan.
            </p>
